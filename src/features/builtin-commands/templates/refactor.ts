...
\`\`\`
TodoWrite([
  {"id": "phase-1", "content": "PHASE 1: Codebase Analysis - launch parallel explore-light agents", "status": "pending", "priority": "high"},
...
4. **OPTIONS**:
   ...
   - Consult oracle-light agent for help
...
## Agents
- \`explore-light\`: Parallel codebase pattern discovery
- \`plan\`: Detailed refactoring plan generation
- \`oracle-light\`: Read-only consultation for complex architectural decisions and debugging
- \`librarian-light\`: **Use proactively** when encountering deprecated methods or library migration tasks. Query official docs and OSS examples for modern replacements.

## Deprecated Code & Library Migration
When you encounter deprecated methods/APIs during refactoring:
1. Fire \`librarian-light\` to find the recommended modern alternative
2. **DO NOT auto-upgrade to latest version** unless user explicitly requests migration
3. If user requests library migration, use \`librarian-light\` to fetch latest API docs before making changes
