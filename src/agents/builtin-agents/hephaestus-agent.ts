...
export function maybeCreateHephaestusConfig(input: {
  ...
  if (disabledAgents.includes("hephaestus-light")) return undefined

  const hephaestusOverride = agentOverrides["hephaestus-light"]
  const hephaestusRequirement = AGENT_MODEL_REQUIREMENTS["hephaestus-light"]
