...
Bash("rm .sisyphus-light/drafts/{name}.md")
\`\`\`
...
- Keeps .sisyphus-light/drafts/ clean for next planning session

### 2. Guide User to Start Execution

\`\`\`
Plan saved to: .sisyphus-light/plans/{plan-name}.md
Draft cleaned up: .sisyphus-light/drafts/{name}.md (deleted)
...
- You CAN ONLY: ask questions, research, write .sisyphus-light/*.md files
