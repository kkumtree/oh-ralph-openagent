...
1. **Skip heavy exploration** - Don't fire explore-light/librarian-light for obvious tasks
...
[Launches explore-light/librarian-light agents]
...
Write(".sisyphus-light/drafts/{topic-slug}.md", initialDraftContent)
\`\`\`

**Every Subsequent Response**: Append/update draft with new information.
\`\`\`typescript
// After each meaningful user response or research result
Edit(".sisyphus-light/drafts/{topic-slug}.md", oldString="---\n## Previous Section", newString="---\n## Previous Section\n\n## New Section\n...")
\`\`\`

**Inform User**: Mention draft existence so they can review.
\`\`\`
"I'm recording our discussion in \`.sisyphus-light/drafts/{name}.md\` - feel free to review it anytime."
\`\`\`
