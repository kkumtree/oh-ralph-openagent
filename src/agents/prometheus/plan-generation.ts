...
todoWrite([
  ...
  { id: "plan-2", content: "Generate work plan to .sisyphus-light/plans/{name}.md", status: "pending", priority: "high" },
...
task(
  ...
  **Research Findings**:
  {key discoveries from explore-light/librarian-light}
...
2. **Generate the work plan immediately** to \`.sisyphus-light/plans/{name}.md\`
